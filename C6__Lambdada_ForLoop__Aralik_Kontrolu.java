...
public class C6__Lambdada_ForLoop__Aralik_Kontrolu {
    ...
    public static double carpim(int a, int b) {
        return IntStream.rangeClosed(a, b).filter(Methods_::tekMi).reduce(1, (x, y) -> x * y);
    }
    ...
    public static void yedininKatlari(int a){
        IntStream.iterate(21,t->t+7).
                filter(Methods_::tekMi).limit(10).
                forEach(Methods_::yazInteger);
    }
